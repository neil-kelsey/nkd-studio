  ...
  return (
    <article className={styles.intro}>
      <div className="container">
        ...
        <p>I create new sites and improve old; adding mobile responsive solutions, SEO and accessibility audits and much much more - offering on-going support using technologies such as React, Wordpress, Next.js, Shopify, JavaScript and PHP.</p>
